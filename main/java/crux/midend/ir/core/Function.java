 ...
 * difference to the AST version is, that the body of the function does not consist of a list of
 * statements, but instead it is a graph, in which instructions are nodes and the control flow are
 * the edges.
 */
